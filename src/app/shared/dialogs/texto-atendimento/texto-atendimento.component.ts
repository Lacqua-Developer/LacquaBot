...
@Component({
  ...
  templateUrl: './texto-atendimento.component.html',
  styleUrls: ['./texto-atendimento.component.scss']
})
export class TextoAtendimentoComponent  {

  constructor(
    public dialogRef: MatDialogRef<TextoAtendimentoComponent>,
